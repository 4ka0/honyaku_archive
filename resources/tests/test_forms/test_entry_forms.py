...
from ...forms.entry_forms import EntryForm, EntryAddToGlossaryForm
...
class TestEntryAddToGlossaryForm(TestCase):
    ...
    def test_form_with_notes_valid_input(self):
        ...
        self.assertEqual(self.valid_form_with_notes.cleaned_data["notes"], "Some test notes.")
    ...
    def test_form_with_invalid_input_no_source(self):
        ...
        self.assertEqual(
            self.invalid_form_no_source.errors["source"],
            ["このフィールドは入力必須です。"]
        )
    ...
    def test_form_with_invalid_input_no_target(self):
        ...
        self.assertEqual(
            self.invalid_form_no_target.errors["target"],
            ["このフィールドは入力必須です。"]
        )
