    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('glossary', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entries', to='archive.glossary')),
        ...
        migrations.AddIndex(
            model_name='glossary',
            index=models.Index(fields=['title'], name='archive_g_title_d378e8_idx'),
        ),
    ]
